 ...
 * @param dictionary
 * @returns {string} @example "Diligência e Reunião"
 */
export function cleanRtfString(
  str: string,
  dictionary: IDictionary<string>
): string {
  return replaceArrayRegex(eraseRtfCode(str), dictionary);
}

/**
 * Recebe string e troca os valores de acordo com o dicionario
 * @param {string} str @example Dilig\'eancia e Reuni\'e3o
 * @param {{string: string}} dictionary
 * @returns {string} string com valores substituídos @example "\r\nDiligência e Reunião \r\n \r\n\u0000"
 */
